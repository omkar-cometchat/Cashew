...
import 'package:budget/pages/sharedBudgetChatPage.dart';
...
class _BudgetPageContentState extends State<_BudgetPageContent> {
  ...
  Widget _floatingActionButtons(BuildContext context) {
    final addTransactionFab = AddFAB(
    ...
    if (widget.budget.sharedKey == null) return addTransactionFab;
    ...
    return Row(
      ...
      children: [
        FAB(
          ...
          openPage: SharedBudgetChatPage(budget: widget.budget),
          color: Theme.of(context).colorScheme.secondaryContainer,
          colorIcon: Theme.of(context).colorScheme.onSecondaryContainer,
          fabSize: getIsFullScreen(context) == false ? 54 : 64,
          borderRadius: getIsFullScreen(context) == false ? 16 : 20,
        ),
      ...
      child: PageFramework(
        ...
        subtitle: StreamBuilder<List<CategoryWithTotal>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              return TotalSpent(budget: widget.budget, totalSpent: totalSpent);
            } else {
              return SizedBox.shrink();
            }
          },
        ...
        floatingActionButton: AnimateFABDelayed(
          fab: _floatingActionButtons(context),
        ),
        actions: [
          CustomPopupMenuButton(
            ...
            items: [
              ...
              if (widget.budget.sharedKey != null)
                DropdownItemMenu(
                  id: "manage-sharing",
                  ...
                  action: () {
                    openBottomSheet(
                      ...
                      PopupFramework(
                        ...
                        hasPadding: false,
                        child: SharedBudgetSettings(budget: widget.budget),
                      ),
                    );
                  },
                ),
...
class TotalSpent extends StatefulWidget {
  const TotalSpent({super.key, required this.totalSpent, required this.budget});
